...
public class FileServerTestService extends StageTest<String> {
    ...
    public static final String serverDataPath = System.getProperty("user.dir") +
        File.separator + "src" + File.separator + "service" + File.separator + "data" + File.separator;

    public static final String clientDataPath = System.getProperty("user.dir") +
        File.separator + "src" + File.separator + "service/client" + File.separator + "data" + File.separator;
    ...
    public static TestedProgram getClient() {
        return new TestedProgram("service/client");
    }

    public static TestedProgram getServer() {
        return new TestedProgram("service");
    }
}
