...
public class Utils {
    ...
    public static void deleteTestFiles() {
        File dir = new File(FileServerTestService.serverDataPath);
        ...
        File cdir = new File(FileServerTestService.clientDataPath);
    ...
    public static boolean isClientFileExists(String fileName) {
        return isFileExists(FileServerTestService.clientDataPath + fileName);
    }

    public static boolean isServerFileExists(String fileName) {
        return isFileExists(FileServerTestService.serverDataPath + fileName);
    }

    public static String getServerFileContent(String fileName) {
        return getFileContent(FileServerTestService.serverDataPath + fileName);
    }

    public static String getClientFileContent(String fileName) {
        return getFileContent(FileServerTestService.clientDataPath + fileName);
    }
